...
//                {"4038", "Kundan Kumar Jha", "0901475930", "24 Nguyễn Văn Bảo, Gò Vấp, Hồ Chí Mình", "Nữ" },
		...
		String[] columnNames = { "Mã Sản Phẩm","Mã Hợp Đồng", "Tên Sản Phẩm","Số Lượng Cần Làm"};
		...
		add(scrollPane_1);
		String[] columnNames1 = { "Mã Hợp Đồng", "Mã Nhân Viên Lập","Nhân Viên Lập","Ngày Bắt Đầu","Ngày Kết Thúc","Tiền Đặt Cọc" };
		table_1 = new JTable(data,columnNames1);
		scrollPane_1.setViewportView(table_1);
		
		lblNewLabel = new JLabel("Mã hợp đồng:");
		...
		textField_2.setBounds(134, 186, 171, 33);
		add(textField_2);
		
		lblTnSnPhm = new JLabel("Tên sản phẩm:");
		lblTnSnPhm.setFont(new Font("Times New Roman", Font.PLAIN, 18));
		lblTnSnPhm.setBounds(326, 185, 114, 28);
		add(lblTnSnPhm);
		
		textField_3 = new JTextField();
		textField_3.setColumns(10);
		textField_3.setBounds(451, 188, 392, 33);
		add(textField_3);
		
		lblSLng = new JLabel("Số lượng cần làm:");
		lblSLng.setFont(new Font("Times New Roman", Font.PLAIN, 18));
		lblSLng.setBounds(864, 191, 145, 28);
		add(lblSLng);
